...
namespace Departajare.Controllers
{
    public class VideoGamesController : Controller
    {
        private readonly DepartajareContext _context;

        public VideoGamesController(DepartajareContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ReleaseDate,Genre,Price")] VideoGame videoGame)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ReleaseDate,Genre,Price")] VideoGame videoGame)
        {
            if (id != videoGame.Id)
            {
                return NotFound();
